...
);isc.B._maxIndex=isc.C+172;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$628=0;isc.A.$71l={sum:function(_1,_2,_3){var _4=0;for(var i=0;i<_2.length;i++){var _6=_1[_2[i].name],_7=parseFloat(_6);if(isc.isA.Number(_7)&&_7==_6){_4+=_7}else{if(_6!=null&&_6!=isc.emptyString){return null}}}
...
this.$39a(_4);var _20;if(_5.isRestRequest){if(_4.operations.length>1){if(_5.contentType==this.$89f){_20="<transaction transactionNum=\""+_4.transactionNum+"\">";_20+="<operations>"
for(var i=0;i<_4.operations.length;i++){_20+=_4.operations[i].data}
_20+="</operations>";_20+="</transaction>"}else{_20="{ transaction: { transactionNum: "+_4.transactionNum+", ";_20+="operations: [";for(var i=0;i<_4.operations.length;i++){if(i>0)_20+=", ";_20+=_4.operations[i].data}
_20+="]}}"}}else{_20=_5.data}}else if(_5.useSimpleHttp){_20=_5.data}
isc.RPCManager.$410.push(_4.transactionNum);_4.transactionRequest=isc.Comm[_19]({URL:_3,httpMethod:_5.httpMethod,contentType:_5.contentType,httpHeaders:_5.httpHeaders,bypassCache:_5.bypassCache,data:_20,fields:_11,target:_5.target,callbackParam:_5.callbackParam,transport:_4.transport,blocking:_5.blocking,useSimpleHttp:_5.useSimpleHttp,transactionNum:_4.transactionNum,transaction:_4})}
...
return _1}
,isc.A.$89n=function isc_c_RPCManager__stripRestTags(_1){var _2=_1.indexOf(this.$89h);if(_2!=-1){return _1.substring(_2+this.$89h.length,_1.lastIndexOf(this.$89i))}
return _1}
...
var _9=_2.results;if(_3&&!isc.isAn.Array(_9))_9=[_9];var _10=_2.operations,_11=[];_2.$66n=true;for(var i=0,j=0;i<_10.length;i++){var _14=_10[i];var _15;if(_3&&_14.clientOnly){_15=isc.addProperties(this.createRPCResponse(_2,_14),{isStructured:false})}else{_15=isc.addProperties(this.createRPCResponse(_2,_14),{isStructured:_3,callbackArgs:_2.transport=="scriptInclude"?_9:null,results:_3?_9[j]:_9,data:_3&&_14.isRestRequest?_9[j]:null});j++}
...
if(_15.results&&!_14.isRestRequest){isc.addProperties(_15,_15.results)}}
_11[i]=_15;_2.responses[i]=_15;_2.changed()}
var _17=0;while(_17<_10.length&&!_2.suspended&&!_2.abortCallbacks)
{var _14=_10[_17],_15=_11[_17];this.performOperationReply(_14,_15);_17++}
if(_2.showPrompt)this.doClearPrompt(_2);if(!_2.suspended&&!_2.abortCallbacks){this.clearTransaction(_1)}
delete _2.abortCallbacks;delete _2.$66n;if(_2.offline)this.playbackNextOfflineTransaction();if(_2.$40c){var _18=_14.application?_14.application:this.getDefaultApplication();if(isc.isA.String(_18))_18=window[_18];_18.fireCallback(_2.$40c,"responses",[_2.responses])}}
